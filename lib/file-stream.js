...
var getFileStats = (filePath, fileStats) =>
  ...
  .then((fileStats) => {
    if(!fileStats.isFile()) return reject(error(404, 
 ...
 */
export var byteRangeFileStream = (filePath, fileStats, options={}) => {
